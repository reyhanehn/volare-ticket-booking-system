...
CREATE INDEX idx_vehicle_service_service ON "Vehicle_Service"("Service_ID");
...
CREATE INDEX idx_route_departure ON "Route"("Depature_Date", "Departure_Time");
CREATE INDEX idx_route_arrival ON "Route"("Arrival_Date", "Arrival_Time");
CREATE INDEX idx_route_origin_dest ON "Route"("Origin", "Destination");

-- ================================
--  Ticket and Ticket_Stop Tables
-- ================================
...
CREATE INDEX idx_flight_type ON "Flight"("Type");
...
-- ================================
--  Optional: Partial Indexes (if Status values are skewed)
-- ================================

-- Only if most users are "Active"
CREATE INDEX idx_user_active_status ON "User"("Status") WHERE "Status" = 'Active';

-- Only if most reservations are confirmed
CREATE INDEX idx_reservation_confirmed ON "Reservation"("Status") WHERE "Status" = 'Confirmed';

-- Only if most payments are successful
