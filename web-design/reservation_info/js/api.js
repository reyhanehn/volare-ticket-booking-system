/**
 * API Module - Authenticated fetch helpers and endpoint wrappers for reservation info page
 */
...
(function() {
  ...
  async function getPaymentStatus(reservationId) {
    return fetchWithAuth(`reservation/${encodeURIComponent(reservationId)}/payment_status/`, { method: 'GET' });
  }
  ...
  if (typeof module !== 'undefined' && module.exports) {
    module.exports = window.ReservationInfoAPI;
  }
})();
